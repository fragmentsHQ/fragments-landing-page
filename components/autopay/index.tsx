        ...
        <div className="flex items-center justify-start space-x-6 lg:w-[80%] w-full">
          ...
          <div>
            ...
            <p className="text-base mt-1 md:block hidden leading-[20.16px] text-[#6D6D6D] ">
              Automate transactions across EVM chains, revolutionizing payments
              in the blockchain with effortless management, conditional
              payments, and unprecedented efficiency.
            </p>
          </div>
        </div>
